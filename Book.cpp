...
bool Book::operator==(const Book& rhs) const{
  return author_ == rhs.author_ && title_ == rhs.title_ && page_count_ == rhs.page_count_ && is_digital_ == rhs.is_digital_;
}
/**
  @param     : A reference to the right hand side of the != operator.
...
*/
bool Book::operator!=(const Book& rhs) const{
  if(title_ != rhs.title_ && author_ != rhs.author_ && page_count_ != rhs.page_count_ && is_digital_ != rhs.is_digital_) {
    return false;
  } 
    return true;
}
...
void Book::display() const{
  ...
  if(is_digital_){std::cout<< "It is available digitally.\n";}
  if(!is_digital_){std::cout<< "It is not available digitally.\n";}
}
